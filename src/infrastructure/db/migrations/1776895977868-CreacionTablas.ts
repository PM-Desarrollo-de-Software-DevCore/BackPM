...
export class CreacionTablas1776895977868 implements MigrationInterface {
    name = 'CreacionTablas1776895977868'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Cambiar tipo sin perder datos - primero eliminar el constraint UNIQUE
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        // Revertir tipo de email sin borrar datos
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3"`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "email" nvarchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email")`);
