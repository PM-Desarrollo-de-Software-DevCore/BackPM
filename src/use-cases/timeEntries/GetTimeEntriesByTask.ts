import { getTimeEntriesByTask } from "../../infrastructure/repositories/TimeEntryRepository"
...
export const getTimeEntriesByTaskUseCase = async (taskId: string, userId: string) => {
    ...
    return await getTimeEntriesByTask(taskId)
}
